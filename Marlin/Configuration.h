...
#define STRING_CONFIG_H_AUTHOR "sepp89117" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "UM2+"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0, 80.0, 200, 369} // UM2PLUS
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 20000, 20000, 100, 3000 }
...
#define DEFAULT_TRAVEL_ACCELERATION  20000    // X, Y, Z acceleration for travel (non printing) moves
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (40*60) } // (50*60), (50*60), (4*60)
...
//
// 128x64 pixel display in the Ultimaker 2, with new menus. Note: For compiling with Arduino you need to remove the "SIGNAL(TWI_vect)" function from "libraries/Wire/utility/twi.c"
//
